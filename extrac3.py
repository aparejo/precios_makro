...
url = "http://bg.redvital.com/bgapi.php?modulo=INV&funcion=LISTA_DE_PRECIOS&codigo_desde=C00040001&codigo_hasta=C00060000"
    ...
    with transaction.atomic():
        ...
        for item_data in items:
            ...
            try:
                ...
                tu_modelo.save()
finalizar_tarea_actualizacion("Actualización de productos C4")
